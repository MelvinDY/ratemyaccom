...
export default function Header() {
  ...
  return (
    <header
      className={`${theme.bg} ${scrolled ? 'backdrop-blur-xl shadow-xl' : 'backdrop-blur-md'} sticky top-0 z-50 border-b ${theme.border} transition-all duration-300`}
    >
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center">
            <Link href="/" className="flex items-center space-x-2 group">
              <div className={`bg-gradient-to-r ${theme.accentGradient} text-white font-bold text-xl px-3 py-1 rounded-lg shadow-lg group-hover:shadow-2xl group-hover:scale-105 transition-all duration-300`}>
                RMA
              </div>
          ...
          <div className="hidden md:flex items-center">
            <div className={`inline-flex rounded-xl border ${theme.navBorder} ${theme.navBg} backdrop-blur-sm p-1 shadow-lg`}>
              {navLinks.map((link) => {
                ...
                return (
                  <Button
                    ...
                    className={`${
                      isActive
                        ? `${theme.activeText} bg-white/10 font-semibold`
                        : 'text-white/70'
          ...
          <div className="hidden md:flex items-center space-x-3">
            ...
            <button className={`bg-gradient-to-r ${theme.accentGradient} text-white px-4 py-2 rounded-xl font-medium hover:shadow-lg hover:shadow-lyra-purple-start/50 hover:scale-105 transition-all duration-300 text-sm`}>
              Write Review
            </button>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden py-4 space-y-2 border-t border-white/10 mt-2">
            ...
            <div className="pt-4 space-y-2 border-t border-white/10 mt-4">
              ...
              <button className={`w-full bg-gradient-to-r ${theme.accentGradient} text-white px-4 py-3 rounded-xl font-medium hover:shadow-lg transition-all duration-300`}>
                Write Review
              </button>
            </div>
          </div>
